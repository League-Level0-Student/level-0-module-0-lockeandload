...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjective = JOptionPane.showInputDialog("input a adjective");
		// Get the player to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("input a liquid");
		// Get the player to enter a body part
		String body_part = JOptionPane.showInputDialog("input a body part");
